...
public class Admin_ManageUser extends javax.swing.JFrame {
    ...
    public static String Nombre_Update = "";
    ...
    public Admin_ManageUser() {
        ...
        this.setTitle(" -  Menu gestion de usuario.");
        ...
        //Modelando tabla de usuarios.
        Users_Tbl.setModel(metodo.MostrarUsuarios());
        
        
        //PlaceHolders.
        PlaceHolder PH = new PlaceHolder("Nombre", Buscar_Txt);
    ...
    private void initComponents() {
        ...
        Title_Lbl.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        Title_Lbl.setForeground(new java.awt.Color(204, 204, 204));
        Title_Lbl.setText("Menu gestion de usuario.");
        getContentPane().add(Title_Lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, -1, -1));
        ...
        Users_Tbl.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        ...
        if (Users_Tbl.getColumnModel().getColumnCount() > 0) {
            ...
            Users_Tbl.getColumnModel().getColumn(1).setResizable(false);
            Users_Tbl.getColumnModel().getColumn(2).setResizable(false);
            Users_Tbl.getColumnModel().getColumn(3).setResizable(false);
            Users_Tbl.getColumnModel().getColumn(4).setResizable(false);
        }
        ...
        TblName_Lbl.setText("Tabla de usuarios");
        getContentPane().add(TblName_Lbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 150, 150, -1));
    ...
    private void Filtro_CmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Filtro_CmbActionPerformed
        ...
        switch(SelectedIndex){
            ...
            case 1:
                ...
                Users_Tbl.setModel(metodo.FiltrarUsuarios("Activo", Model));
                break;
            
            case 2:
                
                Users_Tbl.setModel(metodo.FiltrarUsuarios("Inactivo", Model));
                break;
    ...
    private void Editar_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Editar_BtnActionPerformed
        ...
        Username_Update = (String) (Users_Tbl.getValueAt(SelectedRow, 2));
        Nombre_Update = (String) (Users_Tbl.getValueAt(SelectedRow, 1));
    ...
    private void Eliminar_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Eliminar_BtnActionPerformed
        ...
        int[] Delete = new int[Users_Tbl.getSelectedRowCount()];
        int Cont = 0;
        
        Delete = Users_Tbl.getSelectedRows();
        
        for (int i = 0; i < Delete.length; i++) {
            
            String IDUser = (String) (Users_Tbl.getValueAt(Delete[i], 0));
